...
import numpy as np
import functools
import yunzhu_data as data
from yunzhu_data import video_transform
import pdb
...
from yunzhu_trainer import GANTrainer
...
def parse_args():
    ...
    parser.add_argument('--model', dest='model',
                        ...
                        default='yunzhu_checkpoint/netG_epoch_120.pth', type=str)

    parser.add_argument('--cfg', dest='cfg_file',
                        help='optional config file',
                        default='./cfg/yunzhu.yml', type=str)
