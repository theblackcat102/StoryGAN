...
class GANTrainer(object):
	def __init__(self, output_dir, config, ratio = 1.0, test_dir = None, tensorboard=False):
		self.config = config
	...
	def build_tensorboard(self):
		model_name = str(datetime.datetime.now().strftime("{}_%b-%d_%H-%M-%S".format(self.config.CONFIG_NAME)))
